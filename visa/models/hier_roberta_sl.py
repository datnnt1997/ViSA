...
class HierRoBERTaSL(RobertaForTokenClassification):
    def __init__(self, config: ABSARoBERTaConfig, **kwargs):
        super(HierRoBERTaSL, self).__init__(config=config, **kwargs)
    ...
    def forward(self,
        ...
        a_logits = self.aspect_layer_1(valid_seq_output)
...
if __name__ == "__main__":
    ...
    model = HierRoBERTaSL.from_pretrained('vinai/phobert-base', config=config)
