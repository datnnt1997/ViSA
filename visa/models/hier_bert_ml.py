...
from .configuration import ABSABERTConfig
import torch
...
class HierBertML(BertForTokenClassification):
    def __init__(self, config: ABSABERTConfig, **kwargs):
        super(HierBertML, self).__init__(config=config, **kwargs)
...
if __name__ == "__main__":
    ...
    model = HierBertML.from_pretrained('vinai/phobert-base', config=config)
